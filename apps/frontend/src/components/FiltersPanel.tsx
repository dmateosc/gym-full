    ...
    <div className="bg-gray-800 border border-gray-700 rounded-lg p-6 space-y-6">
      ...
      <div>
        ...
        <select
          ...
          className="w-full px-4 py-3 bg-gray-700 border border-gray-600 rounded-lg text-white focus:outline-none focus:ring-2 focus:ring-red-500 focus:border-transparent transition-all duration-200 cursor-pointer"
        >
